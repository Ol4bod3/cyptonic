            ...
            <div className="flex-1">
              ...
              >
                <div className="flex items-center justify-between text-sm lg:text-base">
                  <div className="px-4 py-1 font-medium bg-white rounded-full text-darkblue">
                    75% SAVE
                  </div>
              ...
              <h1
                className="text-[32px] lg:text-[44px] font-bold leading-tight mb-6"
                data-aos="fade-down"
                data-aos-delay="500"
              >
                Fastest & secure paltform to invest in crypto.
              </h1>
              <p
              ...
              <button
                className="pl-6 text-sm btn gap-x-6 lg:h-16 lg:text-base"
                data-aos="fade-down"
                data-aos-delay="700"
              >
                Try for free
