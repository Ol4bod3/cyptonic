...
const Trade = () => {
  ...
  return (
    <section className="section lg:pt-[320px] bg-gradient-to-b from-[#f8f9fb] to-[#fafbff] text-darkblue lg:-mt-[220px]">
                  ...
                  <button
                    className={`${
                      name === itemName
                        ...
                        : "text-blue w-16"
                    } border-2 border-gray-300 rounded-full h-16 flex justify-center items-center px-3`}
                  >
                    {name === itemName && (
